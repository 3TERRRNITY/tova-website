      ...
      <div className={styles.madaia}>
        ...
        <div className={styles.madaia__info}>
          ...
          <div className={styles.madaia__info__paragraph}>
            ...
            вдохновителем которого является бывшая профессиональная теннисистка
            Майя Кацитадзе. Майю зажигает теннис, побуждает ее творить красоту,
            бренд Madaia - результат вдохновения.
          </div>
          <div className={styles.madaia__info__paragraph}>
            Миссия бренда - помочь каждой женщине создать комфортный и
            лаконичный гардероб. Нами движет женственность, минимализм в деталях
            и желание сделать ваш образ уникальным, где бы вы ни были: на
            прогулке с друзьями, в незабываемом путешествии или в теннисном
            корте.
          </div>
          <div className={styles.madaia__info__paragraph}>
        ...
        <div className={styles.madaia__desktopDesign}>
          <img src="/projects/madaia/madaia1.png" alt="desktop design" />
        </div>
        <div className={styles.madaia__tabletDesign}>
          <img src="/projects/madaia/madaia2.png" alt="tablet design" />
        </div>
        <div className={styles.madaia__clothes}>
          <img src="/projects/madaia/madaia3.png" alt="clothes" />
          <img src="/projects/madaia/madaia4.png" alt="clothes" />
        </div>
        <div className={styles.madaia__mobileDesign}>
          <img src="/projects/madaia/madaia5.png" alt="mobile design" />
        </div>

        <div className={styles.madaia__team}>
          <div className={styles.madaia__team_title}>над проектом работали</div>
              ...
              ({ position, name }: { position: string; name: string[] }) => (
                <div className={styles.madaia__team_member} key={position}>
                  ...
                  <div className={styles.madaia__team_member_nameContainer}>
                    {name.map((n) => (
                      <div className={styles.madaia__team_member_name} key={n}>
                        {n}
                      </div>
                    ))}
                  </div>
