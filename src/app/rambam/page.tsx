    ...
    <div className={commonStyles.otherPageBody}>
      ...
      <div className={styles.rambam}>
        ...
        <div className={styles.rambam__mainPage}>
          <div className={styles.rambam__mainPage__info}>
            <div className={styles.rambam__mainPage__info_description}>
              ...
              белый на темно-зеленом, светло-зеленом или другом контрастном фоне
              и светло-зеленый логотип на белом фоне.
            </div>
            <div className={styles.rambam__mainPage__info_description}>
        ...
        <div className={styles.rambam__mainPage}>
          <div className={styles.rambam__mainPage__info}>
            ...
            <div className={styles.rambam__mainPage__info_description}>
              ...
              читабельными. Ниже приведены неправильные варианты использования.
            </div>
          </div>
        ...
        <div className={styles.rambam__mainPage}>
          <div className={styles.rambam__mainPage__info}>
            ...
            <div className={styles.rambam__mainPage__info_description}>
              ...
              можно использовать для основного текста. IBM Plex Sans Bold можно
              использовать в заголовках и подзаголовках, когда требуется более
              сильный акцент.
            </div>
          </div>
        ...
        <div className={styles.rambam__team}>
          <div className={styles.rambam__team_title}>Над проектом работали</div>
          {team.map((member) => (
